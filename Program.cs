        ...
        while (isRunning)
        {
            ...
            switch (pilihan)
            {
                ...
                case "4":
                    ...
                    Console.WriteLine("Terimakasih telah percaya sama saya:)");
                    break;

                default:
                    Console.WriteLine("Pilihan tidak ada. Silakan coba lagi mungkin anda belum melakukan hal baik:) .");
                    break;
            }
            ...
            if (isRunning)
            {
                ...
                Console.WriteLine("Nah udah tau kan? ayo balik ke halaman utama, tekan tombol apa aja yang penting bukan tombol masuk neraka");
                Console.ReadKey();
            }
        }
    }
